...
public abstract partial class SharedPseudoItemSystem : EntitySystem
{
        ...
        StorageComponent? storage = null)
    {
        ...
        var itemComp = new ItemComponent
            { Size = component.Size, Shape = component.Shape, StoredOffset = component.StoredOffset, StoredRotation = component.StoredRotation, StoredScale = component.StoredScale }; // Frontier: added StoredRotation, //Cataclysm14, added StoredScale
